        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                <div class="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] lg:rounded-br-none lg:rounded-tl-lg lg:p-20">
                    <h1 class="text-xl font-medium">{{ page.props.name }}</h1>
                    <h3 class="mb-1 text-sm font-light">by Nagara</h3>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        SISNAGARA (Sistem Informasi Surat Nagara)
                        Sistem Informasi digital berbasis AI yang dirancang untuk mengelola, mengekstraksi, dan merender dokumen secara cerdas dan efisien.
                    </p>
